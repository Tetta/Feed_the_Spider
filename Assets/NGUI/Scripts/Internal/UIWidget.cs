...
public class UIWidget : UIRect
{
	...
	public void CheckLayer ()
	{
		...
		{
			//D/ebug.LogWarning("You can't place widgets on a layer different than the UIPanel that manages them.\n" +
	...
	protected override void OnStart ()
	{
		...
		{
			//D/ebug.LogError("Widgets and panels should not be on the same object! Widget must be a child of the panel.", this);
		}
