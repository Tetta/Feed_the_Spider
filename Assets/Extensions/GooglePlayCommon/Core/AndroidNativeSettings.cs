...
public class AndroidNativeSettings : ScriptableObject {
	...
	public const string VERSION_NUMBER = "7.8";
	public const string GOOGLE_PLAY_SDK_VERSION_NUMBER = "9.2.0";
	public const string GOOGLE_PLAY_SDK_LEAGCY_VERSION_NUMBER = "9256000";
