...
public class gHintClass : MonoBehaviour {
    ...
    void level12_0 () {
		...
		actions[0].id = new Vector3(0.3125F, -0.6425781F, 0F); //web
		actions[0].frame = 50;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.1425781F, -1.013672F, 0F); //sluggish
		actions[1].frame = 90;
		actions[1].mouse = new Vector3(-0.9555035F, -0.4543326F, 0F);
		actions[2].id = new Vector3(0.3125F, -0.6425781F, 0F); //web
		actions[2].frame = 90;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.3730469F, 0.3359375F, 0F); //sluggish
		actions[3].frame = 71;
		actions[3].mouse = new Vector3(0.3653396F, -0.06088996F, 0F);
	...
	void level12_1 () {
		...
		actions[1].id = new Vector3(-0.1425781F, -1.013672F, 0F); //sluggish
		actions[1].frame = 76;
		actions[1].mouse = new Vector3(0.2107728F, -1.381733F, 0F);
		actions[2].id = new Vector3(0.3125F, -0.6425781F, 0F); //web
		actions[2].frame = 69;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		...
		actions[3].frame = 31;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.3730469F, 0.3359375F, 0F); //sluggish
		actions[4].frame = 82;
		actions[4].mouse = new Vector3(0.5386416F, -0.3091335F, 0F);
	}
    ...
    void level7_0()
    {
		...
		actions[0].id = new Vector3(0.546875F, 0.2871094F, 0F); //web
		actions[0].frame = 56;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.1621094F, -0.07421875F, 0F); //sluggish
		actions[1].frame = 64;
		actions[1].mouse = new Vector3(-0.4683841F, 0.3653395F, 0F);
		actions[2].id = new Vector3(0.546875F, 0.2871094F, 0F); //web
		actions[2].frame = 109;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.1347656F, 0.7910156F, 0F); //web
		actions[3].frame = 40;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.1621094F, -0.07421875F, 0F); //sluggish
		actions[4].frame = 62;
		actions[4].mouse = new Vector3(-0.8009368F, 0.2201405F, 0F);
		actions[5].id = new Vector3(0.546875F, 0.2871094F, 0F); //web
		actions[5].frame = 156;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(0.546875F, 0.2871094F, 0F); //web
		actions[6].frame = 75;
		actions[6].mouse = new Vector3(0F, 0F, 0F);
		actions[7].id = new Vector3(-0.1347656F, 0.7910156F, 0F); //web
		actions[7].frame = 69;
		actions[7].mouse = new Vector3(0F, 0F, 0F);
		actions[8].id = new Vector3(-0.1621094F, -0.07421875F, 0F); //sluggish
		actions[8].frame = 98;
		actions[8].mouse = new Vector3(0.1826698F, 0.2388759F, 0F);
    }
    void level7_1()
    {
        actions = new action[4];

		actions[0].id = new Vector3(-0.1347656F, 0.7910156F, 0F); //web
		actions[0].frame = 50;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.1621094F, -0.07421875F, 0F); //sluggish
		actions[1].frame = 61;
		actions[1].mouse = new Vector3(0.412178F, 0.1405153F, 0F);
		actions[2].id = new Vector3(-0.1347656F, 0.7910156F, 0F); //web
		actions[2].frame = 150;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.1621094F, -0.07421875F, 0F); //sluggish
		actions[3].frame = 80;
		actions[3].mouse = new Vector3(0.117096F, 0.09367681F, 0F);
    }
    ...
    {
        actions = new action[4];
        actions[0].id = new Vector3(0.203125F, 1.40625F, 0F); //web
        actions[0].frame = 33;
        actions[0].mouse = new Vector3(0F, 0F, 0F);
        actions[1].id = new Vector3(0.203125F, 1.40625F, 0F); //web
        actions[1].frame = 89;
        actions[1].mouse = new Vector3(0F, 0F, 0F);
        actions[2].id = new Vector3(-0.4746094F, -0.1992188F, 0F); //sluggish
        actions[2].frame = 150;
        actions[2].mouse = new Vector3(-1.442623F, -0.1659204F, 0F);
        actions[3].id = new Vector3(-0.4746094F, -0.1992188F, 0F); //sluggish
        actions[3].frame = 150;
        actions[3].mouse = new Vector3(-1.241218F, 0.9709884F, 0F);
    }
    ...
    void level6_1()
    {
        ...
        actions[1].frame = 101;
        actions[1].mouse = new Vector3(0F, 0F, 0F);
        actions[2].id = new Vector3(0.203125F, 1.40625F, 0F); //web
        actions[2].frame = 20;
        actions[2].mouse = new Vector3(0F, 0F, 0F);
        actions[3].id = new Vector3(0.203125F, 1.40625F, 0F); //web
        actions[3].frame = 162;
        actions[3].mouse = new Vector3(0F, 0F, 0F);
    ...
    */
    void level10_0 () {
        ...
        actions[0].frame = 109;
        actions[0].mouse = new Vector3(-0.7915691F, 0.412178F, 0F);
        actions[1].id = new Vector3(0.3222656F, 0.9082031F, 0F); //web
        actions[1].frame = 75;
        actions[1].mouse = new Vector3(0F, 0F, 0F);
        actions[2].id = new Vector3(0.3222656F, 0.9082031F, 0F); //web
        actions[2].frame = 140;
        actions[2].mouse = new Vector3(0F, 0F, 0F);
        actions[3].id = new Vector3(0.07617188F, -0.3125F, 0F); //web
        actions[3].frame = 28;
        actions[3].mouse = new Vector3(0F, 0F, 0F);
        actions[4].id = new Vector3(0.2382813F, -0.7617188F, 0F); //sluggish
        actions[4].frame = 70;
        actions[4].mouse = new Vector3(-0.2201405F, -1.039813F, 0F);
        actions[5].id = new Vector3(0.07617188F, -0.3125F, 0F); //web
        actions[5].frame = 130;
        actions[5].mouse = new Vector3(0F, 0F, 0F);
	...
	void level8_0 () {
		...
		actions[0].id = new Vector3(0.2558594F, 1.232422F, 0F); //web
		actions[0].frame = 79;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.7011719F, 0.5976563F, 0F); //web
		actions[1].frame = 172;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.6796875F, 0.08789063F, -0.015625F); //sluggish
		actions[2].frame = 112;
		actions[2].mouse = new Vector3(-0.6791568F, -0.3793911F, 0F);
		actions[3].id = new Vector3(-0.7011719F, 0.5976563F, 0F); //web
		actions[3].frame = 111;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.4472656F, 0.3164063F, 0F); //web
		actions[4].frame = 42;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(-0.6796875F, 0.08789063F, -0.015625F); //sluggish
		actions[5].frame = 40;
		actions[5].mouse = new Vector3(-0.6744731F, -0.2622951F, 0F);
    }
	void level8_1 () {
		actions = new action[4];
		...
		actions[0].frame = 49;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.4472656F, 0.3164063F, 0F); //web
		actions[1].frame = 156;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.2558594F, 1.232422F, 0F); //web
		actions[2].frame = 59;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
    ...
    void level20_0 () {
		...
		actions[0].frame = 40;
		actions[0].mouse = new Vector3(-0.1145833F, 0.9895833F, 0F);
		actions[1].id = new Vector3(0.6972656F, 0.3496094F, 0F); //destroyer
		actions[1].frame = 60;
		actions[1].mouse = new Vector3(0.25F, 0.05729175F, 0F);
	}
	void level20_1 () {
		actions = new action[2];
		...
		actions[0].id = new Vector3(-0.6914063F, 1.396484F, 0F); //destroyer
		actions[0].frame = 77;
		actions[0].mouse = new Vector3(-0.412178F, 1.203747F, 0F);
		actions[1].id = new Vector3(0.6972656F, 0.3496094F, 0F); //destroyer
		actions[1].frame = 95;
		actions[1].mouse = new Vector3(0.3419204F, 0.009367704F, 0F);
	}
	...
	void level22_0 () {
		...
		actions[0].id = new Vector3(-0.1386719F, 1.216797F, 0F); //web
		actions[0].frame = 148;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.2070313F, -0.9511719F, 0F); //cloud
		actions[1].frame = 257;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.25F, -1.146484F, -0.015625F); //sluggish
		actions[2].frame = 128;
		actions[2].mouse = new Vector3(-0.3700234F, -1.65808F, 0F);
		actions[3].id = new Vector3(-0.1386719F, 1.216797F, 0F); //web
		actions[3].frame = 144;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.1386719F, 1.216797F, 0F); //web
		actions[4].frame = 103;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(-0.25F, -1.146484F, -0.015625F); //sluggish
		actions[5].frame = 146;
		actions[5].mouse = new Vector3(-0.557377F, -1.484777F, 0F);
    }
	void level22_1 () {
		actions = new action[1];
	...
	void level17_0 () {
		...
		actions[0].frame = 51;
		actions[0].mouse = new Vector3(0.4824356F, 0.5105386F, 0F);
		actions[1].id = new Vector3(0.2871094F, 1.125F, 0F); //cloud
		actions[1].frame = 52;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.90625F, -0.2949219F, 0F); //cloud
		actions[2].frame = 121;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.8027344F, -0.4023438F, 0F); //web
		actions[3].frame = 149;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.8027344F, -0.4023438F, 0F); //web
		actions[4].frame = 17;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(0.3105469F, -1.007813F, 0F); //cloud
		actions[5].frame = 39;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(0.8027344F, -0.4023438F, 0F); //web
		actions[6].frame = 134;
		actions[6].mouse = new Vector3(0F, 0F, 0F);
	}
	void level17_1 () {
	...
	void level19_0 () {
        ...
        actions[0].frame = 27;
        actions[0].mouse = new Vector3(0F, 0F, 0F);
        actions[1].id = new Vector3(-0.421875F, 1.380859F, 0F); //cloud
        actions[1].frame = 40;
        actions[1].mouse = new Vector3(0F, 0F, 0F);
        actions[2].id = new Vector3(-0.4648438F, 0.3671875F, 0F); //cloud
        actions[2].frame = 54;
        actions[2].mouse = new Vector3(0F, 0F, 0F);
        actions[3].id = new Vector3(0.6210938F, 0.2460938F, 0F); //cloud
        actions[3].frame = 61;
        actions[3].mouse = new Vector3(0F, 0F, 0F);
        actions[4].id = new Vector3(-0.2363281F, -0.3730469F, 0F); //cloud
        actions[4].frame = 94;
        actions[4].mouse = new Vector3(0F, 0F, 0F);
    }
	void level19_1 () {
		...
		actions[0].frame = 51;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.6210938F, 0.2460938F, 0F); //cloud
		actions[1].frame = 75;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.2363281F, -0.3730469F, 0F); //cloud
		actions[2].frame = 82;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
    }
	...
	void level21_0 () {
		...
		actions[0].id = new Vector3(-0.5839844F, 0.8769531F, 0F); //web
		actions[0].frame = 30;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.7207031F, 1.208984F, 0F); //web
		actions[1].frame = 150;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.5839844F, 0.8769531F, 0F); //web
		actions[2].frame = 71;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.7207031F, 1.208984F, 0F); //web
		actions[3].frame = 69;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.1367188F, 1.376953F, 0F); //destroyer
		actions[4].frame = 239;
		actions[4].mouse = new Vector3(-0.2014052F, 0.02228573F, 0F);
		actions[5].id = new Vector3(-0.5839844F, 0.8769531F, 0F); //web
		actions[5].frame = 117;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
	}
	void level21_1 () {
		...
		actions[1].frame = 150;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.1367188F, 1.376953F, 0F); //destroyer
		actions[2].frame = 78;
		actions[2].mouse = new Vector3(-0.07025761F, 0.4391476F, 0F);
		actions[3].id = new Vector3(0.7207031F, 1.208984F, 0F); //web
		actions[3].frame = 143;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
	}
	...
	void level25_0 () {
		...
		actions[0].id = new Vector3(-0.5625F, 0.1328125F, 0F); //destroyer
		actions[0].frame = 80;
		actions[0].mouse = new Vector3(-0.1358314F, 0.6557376F, 0F);
		actions[1].id = new Vector3(0.5175781F, 0.6933594F, 0F); //web
		actions[1].frame = 53;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.6230469F, 0.046875F, 0F); //sluggish
		actions[2].frame = 65;
		actions[2].mouse = new Vector3(0.2622951F, 0.01873541F, 0F);
		actions[3].id = new Vector3(0.5175781F, 0.6933594F, 0F); //web
		actions[3].frame = 120;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.6230469F, 0.046875F, 0F); //sluggish
		actions[4].frame = 114;
		actions[4].mouse = new Vector3(0.8009368F, 0.3138173F, 0F);
		actions[5].id = new Vector3(-0.4453125F, -0.6054688F, 0F); //web
		actions[5].frame = 90;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(0.2460938F, -1.015625F, 0F); //cloud
		actions[6].frame = 27;
		actions[6].mouse = new Vector3(0F, 0F, 0F);
		actions[7].id = new Vector3(-0.09765625F, -1.185547F, -0.015625F); //sluggish
		actions[7].frame = 90;
		actions[7].mouse = new Vector3(0.295082F, -0.8618267F, 0F);
	}
	void level25_1 () {
		actions = new action[4];

		//actions[0].id = new Vector3(0.2460938F, -1.015625F, 0F); //cloud
		//actions[0].frame = 67;
		//actions[0].mouse = new Vector3(0F, 0F, 0F);
		//actions[1].id = new Vector3(0.6230469F, 0.046875F, 0F); //sluggish
		//actions[1].frame = 123;
		//actions[1].mouse = new Vector3(0.8477752F, 0.4262295F, 0F);
		//actions[2].id = new Vector3(-0.4453125F, -0.6054688F, 0F); //web
		//actions[2].frame = 136;
		//actions[2].mouse = new Vector3(0F, 0F, 0F);
		//actions[3].id = new Vector3(-0.5625F, 0.1328125F, 0F); //destroyer
		//actions[3].frame = 48;
		//actions[3].mouse = new Vector3(-0.2201405F, 0.6088994F, 0F);
		//actions[4].id = new Vector3(-0.09765625F, -1.185547F, -0.015625F); //sluggish
		//actions[4].frame = 87;
		//actions[4].mouse = new Vector3(0.4496487F, -0.8477752F, 0F);

		// alternative challenge 1 star 1 web

		actions[0].id = new Vector3(0.5175781F, 0.6933594F, 0F); //web
		actions[0].frame = 27;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.6230469F, 0.046875F, 0F); //sluggish
		actions[1].frame = 73;
		actions[1].mouse = new Vector3(0.1592506F, -0.1451991F, 0F);
		actions[2].id = new Vector3(0.5175781F, 0.6933594F, 0F); //web
		actions[2].frame = 117;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.5625F, 0.1328125F, 0F); //destroyer
		actions[3].frame = 63;
		actions[3].mouse = new Vector3(-0.1967213F, 0.6088994F, 0F);
	}
	...
	void level23_0 () {
		...
		actions[0].id = new Vector3(-0.6992188F, -0.1445313F, 0F); //destroyer
		actions[0].frame = 42;
		actions[0].mouse = new Vector3(-0.3606557F, 0.6932085F, 0F);
		actions[1].id = new Vector3(0.3417969F, 1.046875F, 0F); //web
		actions[1].frame = 43;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.6171875F, 0.4023438F, -0.015625F); //sluggish
		actions[2].frame = 121;
		actions[2].mouse = new Vector3(0.02341925F, 0.473068F, 0F);
		actions[3].id = new Vector3(0.3417969F, 1.046875F, 0F); //web
		actions[3].frame = 200;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.75F, -0.7304688F, 0F); //web
		actions[4].frame = 43;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(0.6171875F, 0.4023438F, -0.015625F); //sluggish
		actions[5].frame = 34;
		actions[5].mouse = new Vector3(-0.2201405F, 0.2248244F, 0F);
		actions[6].id = new Vector3(0.75F, -0.7304688F, 0F); //web
		actions[6].frame = 76;
		actions[6].mouse = new Vector3(0F, 0F, 0F);
		actions[7].id = new Vector3(-0.5058594F, 0.4433594F, 0F); //web
		actions[7].frame = 35;
		actions[7].mouse = new Vector3(0F, 0F, 0F);
		actions[8].id = new Vector3(0.6171875F, 0.4023438F, -0.015625F); //sluggish
		actions[8].frame = 35;
		actions[8].mouse = new Vector3(0.6932085F, 0.01405144F, 0F);
		actions[9].id = new Vector3(-0.5058594F, 0.4433594F, 0F); //web
		actions[9].frame = 108;
		actions[9].mouse = new Vector3(0F, 0F, 0F);
    }
	void level23_1 () {
		...
		actions[0].id = new Vector3(-0.6992188F, -0.1445313F, 0F); //destroyer
		actions[0].frame = 42;
		actions[0].mouse = new Vector3(-0.3278689F, 0.8196721F, 0F);
		actions[1].id = new Vector3(-0.5058594F, 0.4433594F, 0F); //web
		actions[1].frame = 39;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.3417969F, 1.046875F, 0F); //web
		actions[2].frame = 48;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.3417969F, 1.046875F, 0F); //web
		actions[3].frame = 91;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.5058594F, 0.4433594F, 0F); //web
		actions[4].frame = 97;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
    }
    //--- Ice 1
	...
	void level35_0 () {
		...
		actions[0].id = new Vector3(-0.5175781F, 1.513672F, 0F); //web
		actions[0].frame = 40;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		...
		actions[2].frame = 0;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.7480469F, -0.2207031F, 0F); //sluggish
		actions[3].frame = 180;
		actions[3].mouse = new Vector3(-0.7775176F, -0.6135831F, 0F);
		...
		actions[5].frame = 0;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(-0.7480469F, -0.2207031F, 0F); //sluggish
		actions[6].frame = 100;
		actions[6].mouse = new Vector3(-0.9461359F, -0.03278685F, 0F);
	}
	void level35_1 () {
		actions = new action[4];
		...
		actions[3].id = new Vector3(-0.7480469F, -0.2207031F, 0F); //sluggish
		actions[3].frame = 130;
		actions[3].mouse = new Vector3(-1.067916F, 0.1311476F, 0F);
	}
	...
	void level34_0 () {
		...
		actions[0].id = new Vector3(0.4921875F, 0.5214844F, 0F); //web
		actions[0].frame = 30;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.1933594F, -0.9121094F, 0F); //sluggish
		actions[1].frame = 75;
		actions[1].mouse = new Vector3(0.05620604F, -1.367682F, 0F);
		actions[2].id = new Vector3(0.4921875F, 0.5214844F, 0F); //web
		actions[2].frame = 50;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.4921875F, 0.5214844F, 0F); //web
		actions[3].frame = 38;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.1933594F, -0.9121094F, 0F); //sluggish
		actions[4].frame = 120;
		actions[4].mouse = new Vector3(0.2576112F, -1.325527F, 0F);
		actions[5].id = new Vector3(0.4921875F, 0.5214844F, 0F); //web
		actions[5].frame = 44;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(-0.2734375F, 1.421875F, 0F); //web
		actions[6].frame = 146;
		actions[6].mouse = new Vector3(0F, 0F, 0F);
		actions[7].id = new Vector3(0.4921875F, 0.5214844F, 0F); //web
		actions[7].frame = 89;
		actions[7].mouse = new Vector3(0F, 0F, 0F);
		actions[8].id = new Vector3(-0.2734375F, 1.421875F, 0F); //web
		actions[8].frame = 38;
		actions[8].mouse = new Vector3(0F, 0F, 0F);
	}
	void level34_1 () {
	...
	void level32_0 () {
		...
		actions[0].id = new Vector3(-0.9492188F, 1.53125F, 0F); //web
		actions[0].frame = 44;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.2539063F, -1.477842F, -0.01953125F); //yeti body
		actions[1].frame = 116;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.2539063F, -1.477842F, -0.01953125F); //yeti body
		actions[2].frame = 0;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.2539063F, -1.477842F, -0.01953125F); //yeti body
		actions[3].frame = 90;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.2539063F, -1.477842F, -0.01953125F); //yeti body
		actions[4].frame = 0;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
	}
	void level32_1 () {
		...
		actions[0].frame = 28;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.9492188F, 1.53125F, 0F); //web
		actions[1].frame = 74;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.9492188F, 1.53125F, 0F); //web
		actions[2].frame = 101;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
	}
    //--- Desert 1
    ...
    void level38_0 () {
		...
		actions[0].frame = 54;
		actions[0].mouse = new Vector3(0.2763465F, -0.1592506F, 0F);
		...
		actions[3].frame = 48;
		actions[3].mouse = new Vector3(-0.4777518F, 0.1639345F, 0F);
		actions[4].id = new Vector3(-0.578125F, 0.2148438F, 0F); //groot
		actions[4].frame = 53;
		actions[4].mouse = new Vector3(-0.4496487F, -0.8852459F, 0F);
	...
	void level38_1 () {
		...
		actions[0].id = new Vector3(-0.578125F, 0.2148438F, 0F); //groot
		actions[0].frame = 50;
		actions[0].mouse = new Vector3(-0.2716628F, -0.8758782F, 0F);
		actions[1].id = new Vector3(-0.08398438F, 1.224609F, 0F); //web
		actions[1].frame = 40;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
	}
	...
	void level41_0 () {
		...
		actions[0].frame = 69;
		actions[0].mouse = new Vector3(-0.7775176F, 0.9254144F, 0F);
		actions[1].id = new Vector3(-0.6210938F, 0.4980469F, 0F); //groot
		actions[1].frame = 155;
		actions[1].mouse = new Vector3(0.9836066F, 0.8036348F, 0F);
		actions[2].id = new Vector3(0.5488281F, 1.257813F, 0F); //groot
		actions[2].frame = 97;
		actions[2].mouse = new Vector3(0.4824356F, 1.192393F, 0F);
		actions[3].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[3].frame = 156;
		actions[3].mouse = new Vector3(-0.9039813F, -0.1097143F, 0F);
		actions[4].id = new Vector3(-0.6210938F, 0.4980469F, 0F); //groot
		actions[4].frame = 34;
		actions[4].mouse = new Vector3(-0.557377F, 0.5085527F, 0F);
		actions[5].id = new Vector3(-0.6210938F, 0.4980469F, 0F); //groot
		actions[5].frame = 112;
		actions[5].mouse = new Vector3(-0.4215457F, -0.5359437F, 0F);
		actions[6].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[6].frame = 40;
		actions[6].mouse = new Vector3(0.1639345F, 0.2228385F, 0F);
		actions[7].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[7].frame = 64;
		actions[7].mouse = new Vector3(0.2716628F, -0.9012834F, 0F);
		actions[8].id = new Vector3(-0.6210938F, 0.4980469F, 0F); //groot
		actions[8].frame = 40;
		actions[8].mouse = new Vector3(-0.5901639F, 0.382089F, 0F);
		actions[9].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[9].frame = 97;
		actions[9].mouse = new Vector3(0.3138174F, 0.1994191F, 0F);
	}
	void level41_1 () {
		actions = new action[8];
		...
		actions[0].id = new Vector3(0.5488281F, 1.257813F, 0F); //groot
		actions[0].frame = 65;
		actions[0].mouse = new Vector3(-0.8384075F, 0.9769367F, 0F);
		actions[1].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[1].frame = 117;
		actions[1].mouse = new Vector3(-0.9648712F, -0.2268103F, 0F);
		actions[2].id = new Vector3(0.5488281F, 1.257813F, 0F); //groot
		actions[2].frame = 134;
		actions[2].mouse = new Vector3(0.5011709F, 1.220497F, 0F);
		actions[3].id = new Vector3(-0.6210938F, 0.4980469F, 0F); //groot
		actions[3].frame = 144;
		actions[3].mouse = new Vector3(-0.5854802F, -0.4375831F, 0F);
		actions[4].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[4].frame = 34;
		actions[4].mouse = new Vector3(0.1873536F, 0.2415737F, 0F);
		actions[5].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[5].frame = 82;
		actions[5].mouse = new Vector3(0.2763465F, -0.6764591F, 0F);
		actions[6].id = new Vector3(-0.6210938F, 0.4980469F, 0F); //groot
		actions[6].frame = 50;
		actions[6].mouse = new Vector3(-0.6276346F, 0.4336113F, 0F);
		actions[7].id = new Vector3(0.2929688F, 0.2792969F, 0F); //groot
		actions[7].frame = 82;
		actions[7].mouse = new Vector3(0.2716628F, 0.1900514F, 0F);
	}
	...
	void level40_0 () {
		...
		actions[0].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[0].frame = 30;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.5664063F, 1.117188F, 0F); //web
		actions[1].frame = 62;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		...
		actions[3].frame = 43;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[4].frame = 83;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(-0.5664063F, 1.117188F, 0F); //web
		actions[5].frame = 55;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[6].frame = 95;
		actions[6].mouse = new Vector3(0F, 0F, 0F);
		actions[7].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[7].frame = 14;
		actions[7].mouse = new Vector3(0F, 0F, 0F);
		actions[8].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[8].frame = 90;
		actions[8].mouse = new Vector3(0F, 0F, 0F);
	}
	void level40_1 () {
		...
		actions[3].frame = 50;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.5664063F, 1.117188F, 0F); //web
		actions[4].frame = 65;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[5].frame = 92;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(0.5488281F, 1.339844F, 0F); //web
		actions[6].frame = 26;
	...
	void level13_0 () {
		...
		actions[0].id = new Vector3(-0.05273438F, -0.7792969F, 0F); //web
		actions[0].frame = 59;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.6464844F, -1.001953F, 0F); //sluggish
		actions[1].frame = 43;
		actions[1].mouse = new Vector3(0.6088992F, -1.278689F, 0F);
		actions[2].id = new Vector3(-0.05273438F, -0.7792969F, 0F); //web
		actions[2].frame = 86;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.6464844F, -1.001953F, 0F); //sluggish
		actions[3].frame = 52;
		actions[3].mouse = new Vector3(0.6510538F, -1.433255F, 0F);
		actions[4].id = new Vector3(0.6621094F, 0.5546875F, 0F); //sluggish
		actions[4].frame = 69;
		actions[4].mouse = new Vector3(0.9227166F, -0.06557381F, 0F);
    }
	void level13_1 () {
		actions = new action[3];

		actions[0].id = new Vector3(0.6464844F, -1.001953F, 0F); //sluggish
		actions[0].frame = 66;
		actions[0].mouse = new Vector3(0.9555035F, -0.9180328F, 0F);
		actions[1].id = new Vector3(0.6464844F, -1.001953F, 0F); //sluggish
		actions[1].frame = 148;
		actions[1].mouse = new Vector3(0.6885245F, -1.480094F, 0F);
		actions[2].id = new Vector3(0.6621094F, 0.5546875F, 0F); //sluggish
		actions[2].frame = 65;
		actions[2].mouse = new Vector3(0.8665106F, 0.09367681F, 0F);
    }
	...
	void level9_0 () {
		...
		actions[0].id = new Vector3(-0.02539063F, -0.4179688F, 0F); //web
		actions[0].frame = 53;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.3046875F, -1.244141F, -0.015625F); //sluggish
		actions[1].frame = 57;
		actions[1].mouse = new Vector3(-0.2669789F, -1.152225F, 0F);
		actions[2].id = new Vector3(-0.02539063F, -0.4179688F, 0F); //web
		actions[2].frame = 92;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.2890625F, 0.8984375F, 0F); //web
		actions[3].frame = 31;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.4589844F, 0.2675781F, -0.015625F); //sluggish
		actions[4].frame = 64;
		actions[4].mouse = new Vector3(-0.9836066F, 0.3185012F, 0F);
		actions[5].id = new Vector3(-0.4589844F, 0.2675781F, -0.015625F); //sluggish
		actions[5].frame = 79;
		actions[5].mouse = new Vector3(0.3091335F, 0.05620599F, 0F);
	}
	void level9_1 () {
		actions = new action[4];
		...
		actions[1].id = new Vector3(0.3046875F, -1.244141F, -0.015625F); //sluggish
		actions[1].frame = 50;
		actions[1].mouse = new Vector3(0.6932085F, -0.9648712F, 0F);
		actions[2].id = new Vector3(-0.02539063F, -0.4179688F, 0F); //web
		actions[2].frame = 47;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.4589844F, 0.2675781F, -0.015625F); //sluggish
		actions[3].frame = 71;
		actions[3].mouse = new Vector3(-0.6838408F, -0.266979F, 0F);
	}
	...
	void level18_0 () {
		...
		actions[0].frame = 30;
		actions[0].mouse = new Vector3(0.4262296F, 0.5761125F, 0F);
	...
	void level18_1 () {
		...
		actions[0].id = new Vector3(0.7519531F, 0.7070313F, 0F); //destroyer
		actions[0].frame = 29;
		actions[0].mouse = new Vector3(0.5526932F, 0.6229508F, 0F);
	...
	void level24_0 () {
		...
		actions[0].id = new Vector3(0.7714844F, 0.4042969F, 0F); //web
		actions[0].frame = 90;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.21875F, -0.4804688F, 0F); //web
		actions[1].frame = 111;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.5097656F, 1.263672F, 0F); //web
		actions[2].frame = 62;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.7714844F, 0.4042969F, 0F); //web
		actions[3].frame = 124;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.21875F, -0.4804688F, 0F); //web
		actions[4].frame = 64;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(0.7714844F, 0.4042969F, 0F); //web
		actions[5].frame = 63;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
	}
	void level24_1 () {
		...
		actions[0].id = new Vector3(-0.5097656F, 1.263672F, 0F); //web
		actions[0].frame = 83;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.7714844F, 0.4042969F, 0F); //web
		actions[1].frame = 83;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.21875F, -0.4804688F, 0F); //web
		actions[2].frame = 66;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.21875F, -0.4804688F, 0F); //web
		actions[3].frame = 69;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
	}
	...
	void level33_1 () {
		...
		actions[3].frame = 36;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(0.6777344F, -0.09570313F, 0F); //web
		actions[4].frame = 24;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
    }
	...
	void level31_0 () {
		...
		actions[0].id = new Vector3(-0.6523438F, 0.2070313F, 0F); //web
		actions[0].frame = 173;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(-0.6523438F, 0.2070313F, 0F); //web
		actions[1].frame = 149;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.5996094F, 0.05273438F, 0F); //web
		actions[2].frame = 78;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.6523438F, 0.2070313F, 0F); //web
		actions[3].frame = 126;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
	}
	void level31_1 () {
		...
		actions[0].frame = 60;
		actions[0].mouse = new Vector3(0F, 0F, 0F);
		actions[1].id = new Vector3(0.5996094F, 0.05273438F, 0F); //web
		actions[1].frame = 50;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
	}
	...
	void level30_0 () {
		...
		actions[0].id = new Vector3(0.5F, 0.5136719F, -0.015625F); //sluggish
		actions[0].frame = 60;
		actions[0].mouse = new Vector3(0.6042155F, 0.1217564F, 0F);
		actions[1].id = new Vector3(0.1699219F, 2.099609F, 0F); //web
		actions[1].frame = 81;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(0.1699219F, 2.099609F, 0F); //web
		actions[2].frame = 119;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(-0.1660156F, 0.7636719F, 0F); //web
		actions[3].frame = 29;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.1660156F, 0.7636719F, 0F); //web
		actions[4].frame = 50;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(0.5F, 0.5136719F, -0.015625F); //sluggish
		actions[5].frame = 60;
		actions[5].mouse = new Vector3(0.05620604F, 1.007002F, 0F);
	}
	void level30_1 () {
		actions = new action[4];
		...
		actions[0].id = new Vector3(0.5F, 0.5136719F, -0.015625F); //sluggish
		actions[0].frame = 60;
		actions[0].mouse = new Vector3(0.6088992F, 0.1451757F, 0F);
		actions[1].id = new Vector3(-0.1660156F, 0.7636719F, 0F); //web
		actions[1].frame = 95;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.1660156F, 0.7636719F, 0F); //web
		actions[2].frame = 55;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.5F, 0.5136719F, -0.015625F); //sluggish
		actions[3].frame = 70;
		actions[3].mouse = new Vector3(0.05620604F, 1.007002F, 0F);
	}
	...
	void level43_0 () {
		...
		actions[0].id = new Vector3(0.6679688F, 0.2207031F, 0F); //groot
		actions[0].frame = 54;
		actions[0].mouse = new Vector3(-0.2154567F, 0.9416792F, 0F);
		actions[1].id = new Vector3(0.4375F, -0.8476563F, 0F); //sluggish
		actions[1].frame = 61;
		actions[1].mouse = new Vector3(0.4871194F, -1.189468F, 0F);
		actions[2].id = new Vector3(0.40625F, 1.484375F, 0F); //web
		actions[2].frame = 40;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.6679688F, 0.2207031F, 0F); //groot
		actions[3].frame = 44;
		actions[3].mouse = new Vector3(0.5480093F, 0.2531545F, 0F);
		actions[4].id = new Vector3(0.6679688F, 0.2207031F, 0F); //groot
		actions[4].frame = 54;
		actions[4].mouse = new Vector3(-0.6932085F, -0.04192743F, 0F);
		actions[5].id = new Vector3(0.40625F, 1.484375F, 0F); //web
		actions[5].frame = 44;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
		actions[6].id = new Vector3(0.6679688F, 0.2207031F, 0F); //groot
		actions[6].frame = 120;
		actions[6].mouse = new Vector3(0.5620609F, 0.182897F, 0F);
		actions[7].id = new Vector3(0.4375F, -0.8476563F, 0F); //sluggish
		actions[7].frame = 100;
		actions[7].mouse = new Vector3(0.4918033F, -1.166049F, 0F);
		actions[8].id = new Vector3(0.40625F, 1.484375F, 0F); //web
		actions[8].frame = 47;
		actions[8].mouse = new Vector3(0F, 0F, 0F);
		actions[9].id = new Vector3(-0.7871094F, 1.636719F, 0F); //web
		actions[9].frame = 144;
		actions[9].mouse = new Vector3(0F, 0F, 0F);
	}
	void level43_1 () {
		...
		actions[0].id = new Vector3(0.4375F, -0.8476563F, 0F); //sluggish
		actions[0].frame = 60;
		actions[0].mouse = new Vector3(0.4964872F, -1.156682F, 0F);
		actions[1].id = new Vector3(-0.7871094F, 1.636719F, 0F); //web
		actions[1].frame = 43;
		actions[1].mouse = new Vector3(0F, 0F, 0F);
		actions[2].id = new Vector3(-0.7871094F, 1.636719F, 0F); //web
		actions[2].frame = 63;
		actions[2].mouse = new Vector3(0F, 0F, 0F);
		actions[3].id = new Vector3(0.4375F, -0.8476563F, 0F); //sluggish
		actions[3].frame = 116;
		actions[3].mouse = new Vector3(0.5058548F, -1.236307F, 0F);
		actions[4].id = new Vector3(0.40625F, 1.484375F, 0F); //web
		actions[4].frame = 42;
		actions[4].mouse = new Vector3(0F, 0F, 0F);
		actions[5].id = new Vector3(-0.7871094F, 1.636719F, 0F); //web
		actions[5].frame = 141;
		actions[5].mouse = new Vector3(0F, 0F, 0F);
	}
	...
	void level46_0 () {
		...
		actions[0].id = new Vector3(0.7246094F, 0.5429688F, 0F); //groot
		actions[0].frame = 61;
		actions[0].mouse = new Vector3(-0.7868853F, -0.1612365F, 0F);
		actions[1].id = new Vector3(0.5722656F, -0.21875F, 0F); //groot
		actions[1].frame = 88;
		actions[1].mouse = new Vector3(-0.7447307F, 0.6912225F, 0F);
		actions[2].id = new Vector3(-0.6679688F, 0.1835938F, 0F); //groot
		actions[2].frame = 66;
		actions[2].mouse = new Vector3(0.6697892F, 0.2743605F, 0F);
		actions[3].id = new Vector3(-0.2890625F, 1.154297F, 0F); //cloud
		actions[3].frame = 42;
		actions[3].mouse = new Vector3(0F, 0F, 0F);
		actions[4].id = new Vector3(-0.6679688F, 0.1835938F, 0F); //groot
		actions[4].frame = 144;
		actions[4].mouse = new Vector3(-0.618267F, 0.1994191F, 0F);
		actions[5].id = new Vector3(-0.6679688F, 0.1835938F, 0F); //groot
		actions[5].frame = 60;
		actions[5].mouse = new Vector3(0.5667448F, 0.02143323F, 0F);
		actions[6].id = new Vector3(0.7246094F, 0.5429688F, 0F); //groot
		actions[6].frame = 77;
		actions[6].mouse = new Vector3(0.5667448F, 0.5226041F, 0F);
		actions[7].id = new Vector3(0.5722656F, -0.21875F, 0F); //groot
		actions[7].frame = 46;
		actions[7].mouse = new Vector3(0.4777517F, -0.1331335F, 0F);
		actions[8].id = new Vector3(0.5722656F, -0.21875F, 0F); //groot
		actions[8].frame = 57;
		actions[8].mouse = new Vector3(-0.8665105F, -0.2736487F, 0F);
		actions[9].id = new Vector3(-0.6679688F, 0.1835938F, 0F); //groot
		actions[9].frame = 52;
		actions[9].mouse = new Vector3(-0.5761124F, 0.1666323F, 0F);
		actions[10].id = new Vector3(0.5722656F, -0.21875F, 0F); //groot
		actions[10].frame = 89;
		actions[10].mouse = new Vector3(0.4824356F, -0.2268103F, 0F);
	}
	void level46_1 () {
		actions = new action[5];
