...
public class staticClass {
	...
	public static void initLevels () {
        ...
        levels[10, 0] = 3;
        levels[10, 1] = 111;
        levels[11, 0] = 2;	// подумать ещё
        levels[11, 1] = 102;
        levels[12, 0] = 1;
        levels[12, 1] = 103;
        levels[13, 0] = 0;
        levels[13, 1] = 8;
        levels[14, 0] = 3;	// придумать
        levels[14, 1] = 201;
        levels[15, 0] = 1;
        levels[15, 1] = 9;
        levels[16, 0] = 0;	// проверить
        levels[16, 1] = 3;
        levels[17, 0] = 0;
        levels[17, 1] = 0;
        levels[18, 0] = 2;
        levels[18, 1] = 8;	// проверить
        levels[19, 0] = 3;
        levels[19, 1] = 11;	// халява
        levels[20, 0] = 1;
        levels[20, 1] = 14;
        levels[21, 0] = 1;
        levels[21, 1] = 7;
		...
		levels[30, 0] = 1;
		levels[30, 1] = 102;
		levels[31, 0] = 0;	// не работает
		levels[31, 1] = 0;
		levels[32, 0] = 0;	// сложно возможно
		levels[32, 1] = 12;
		levels[33, 0] = 1;
		levels[33, 1] = 8;	// время забыл проверить
		levels[34, 0] = 2;
		levels[34, 1] = 15;
		levels[35, 0] = 2;
		levels[35, 1] = 101;
		levels[36, 0] = 0;
		levels[36, 1] = 10;
		levels[37, 0] = 3;	// виснет
		levels[37, 1] = 101;
		levels[38, 0] = 1;
		levels[38, 1] = 7;
		levels[39, 0] = 0;	// виснет
		levels[39, 1] = 8;
		levels[40, 0] = 3;
		levels[40, 1] = 8;
		levels[41, 0] = 2;
		...
		levels[50, 1] = 12;
		//----------------------------
        levels[51, 0] = 1;	// не стал пробовать, на нормальном хинте плющит и колбасит
        levels[51, 1] = 0;
		levels[52, 0] = 0;
		levels[52, 1] = 15;
		levels[53, 0] = 3;
		...
		levels[54, 0] = 1;
		levels[54, 1] = 101;
		levels[55, 0] = 2;	// на этом закончил
		levels[55, 1] = 102;
		levels[56, 0] = 3;
		levels[56, 1] = 11;
		levels[57, 0] = 1;
	...
	public static string strProgressDefault = "googlePlay=0;lastLevel=0;currentLevel=1;coins=0;gems=0;energyTime=0;energy=30;" +
	...
	public static string strProgressCheat = "googlePlay=0;lastLevel=100;currentLevel=100;coins=10000;gems=200;energyTime=0;energy=30;" +
